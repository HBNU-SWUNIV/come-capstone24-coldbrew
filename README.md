...
MATLAB가 Simulation을 이용하여 통신 성능의 차이를 직접 비교함으로써 최적의 경로가 필요한 것을 증명하였습니다.

무조건 통신 시간이 길다고 통신 성능이 좋지 않다는 것을 증명한 후, 1000번의 Simulation을 통해 통신 시간과 왕복 비행 거리의 반비례 관계 사이에서 통신 성능의 최적 임계점을 찾았습니다.
...
### 📕 KICS 한국통신학회, 2024년도 하계종합학술발표회


### 📘 KICS 한국통신학회, 2024년도 추계종합학술발표회
