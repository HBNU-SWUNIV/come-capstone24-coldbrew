...
<div style="text-align: center;">
    <img src="img/terrain_limitation.jpg" width="400" height="300" alt="지형적 제한" style="margin-right: 20px;">
    <img src="img/war_communication_failure.jpg" width="400" height="300" alt="전쟁상황 통신시스템 파괴">
</div>
